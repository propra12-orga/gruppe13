...
public class MyClientSocket implements MySockets {
						...
						try {
							if (socket.isConnected()) {
								...
								if (message instanceof Figur) {
									...
									// Position des BM des Clients auf dem eigenen
									// Spielfeld setzen
									MyClientSocket.this.bm1.setxPosition(bmS.getxPosition());
									MyClientSocket.this.bm1.setyPosition(bmS.getyPosition());
								// falls das Objekt vom Typ String ist
								} else if (message instanceof String) {
									String msg = (String) message;
									// überprüfen, ob er "Bombe" enthält
									if (msg.equals("Bombe")) {
										// die Bombe an der Stelle des Server-BMs legen
										control.bombeLegen(MyClientSocket.this.bm1);
									}
								}
							}
	...
	// Methode zum Senden von Objekten an der Server
